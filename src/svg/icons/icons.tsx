...
export const LocationIcon = (color = "#FFF") => (
...
export const MoneyIcon = (color = "#FFF") => (
    <svg xmlns="http://www.w3.org/2000/svg" className={` h-8 w-8 sm:h-12 sm:w-12 md:h-16 md:w-16 2xl:h-20 2xl:w-20 `} fill="none" viewBox="0 0 24 24" stroke={`${color}`}>
...
export const TaxIcon = (color = "#FFF") => (
    <svg xmlns="http://www.w3.org/2000/svg" className={` h-8 w-8 sm:h-12 sm:w-12 md:h-16 md:w-16 2xl:h-20 2xl:w-20 `} fill="none" viewBox="0 0 24 24" stroke={`${color}`}>
...
export const Whatsapp = (color = "#FFF") => (
...
export const Download = (color = "#FFF") => (
    <svg xmlns="http://www.w3.org/2000/svg" className={` h-6 w-6 `} fill="none" viewBox="0 0 24 24" stroke={`${color}`}>
